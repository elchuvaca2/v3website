...
class Site__Customizer
{
    ...
    public static function register($wp_customize)
    {
        ...
        $sections = array(
            [
                ...
                'id' => 'hero__options',
                'args' => array(
                    'title' => __('Hero Options Miguel', '123_parent'), //Visible title of section
                    'panel' => 'site__hero'
                )
            ], [
                'id' => 'miguels__option',
                'args' => array(
                    'title' => __('Miguel colors', '123_parent'), //Visible title of section
                    'panel' => 'site_style'
                )
            ]
        ...
        $color_controls = array(
            [
                ...
                'id' => 'links_button_bg_hover2', 'args' => [
                    
                    'label' => __('Background Color mMiguel', '123_parent'), //Admin-visible name of the control
                    'settings' => 'colors__main_body_bg', //Which setting to load and manipulate (serialized is okay)
                    'section' => 'miguels__option', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
            ...
            [
                'id' => 'fonts__body', 'args' => [
                    ...
                    , 'type' => 'select', 'choices' => array(
                        'lato' => 'Lato', 'gotham' => 'Gotham','acme' => 'Acme', 'abel' => 'Abel','actor' => 'Actor', 'Alef' => 'Alef'
                    )
                ]
            ], [
    ...
    public static function header_output()
    {
        ...
        $settings = array(
            ['body', 'background-color', 'colors__main_body_bg', '', ''],
