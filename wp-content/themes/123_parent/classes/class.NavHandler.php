...
class NavHandler
{
    ...
    function _init(){
         ...
         */
        $format_header = '
            <header class="%s header" id="opt_header_one" style=" background-color:'.get_theme_mod( 'background_setting_header', '#FFFFFF' ).'">
                <div  style=" background-color:'.get_theme_mod( 'background_setting_header', '#FFFFFF' ).'">
                    %s
                    <div>
                        %s
                        %s
                ...
                <div style=" background-color:'.get_theme_mod( 'background_setting_nav', '#FFFFFF' ).'" >
                    <nav >
                        %s  
                        %s
                    </nav>
         ...
         */
        $format_header = '
            <header class="header %s site_colors_header_bg" id="opt_header_two" style=" background-color:'.get_theme_mod( 'background_setting_header', '#FFFFFF' ).'">
                <div class="header-tint site_colors_header_bg" style=" background-color:'.get_theme_mod( 'background_setting_header', '#FFFFFF' ).';">  
                    %s
                    <div>
                        %s
         ...
         */
        $format_header = '
            <header class="header %s" id="opt_header_three" style=" background-color:'.get_theme_mod( 'background_setting_header', '#FFFFFF' ).'">   
                <div style=" background-color:'.get_theme_mod( 'background_setting_header', '#FFFFFF' ).'"> 
                    %s
                    %s
                </div>
                <div class="header-content" style=" background-color:'.get_theme_mod( 'background_setting_nav', '#FFFFFF' ).';color: red !important;">
                    %s
                    %s
                </div>
            </header>
        ...
        $format_header = '
            <header class="%s header" id="opt_header_four" >
                <div class="outer_div" style=" background-color:'.get_theme_mod( 'background_setting_header', '#FFFFFF' ).'">
                    <div class="inner_div" style=" background-color:'.get_theme_mod( 'background_setting_header', '#FFFFFF' ).'">
                        %s
                        %s
                        %s
                    </div>
                </div>
                <nav style=" background-color:'.get_theme_mod( 'background_setting_nav', '#FFFFFF' ).'">
                    %s
                </nav>
            </header>
        ';
        ...
        $format_header = '
            <header class="%s header" id="opt_header_five" >
                ...
                <div class="outer_div" style=" background-color:'.get_theme_mod( 'background_setting_nav', '#FFFFFF' ).'">
                    <div class="inner_div" style=" background-color:'.get_theme_mod( 'background_setting_nav', '#FFFFFF' ).'"> 
                        %s
                        <nav>
                            %s
                        </nav>
         ...
         */
        $format_header = '
            <header class="%s header" id="opt_header_six" style=" background-color:'.get_theme_mod( 'background_setting_header', '#FFFFFF' ).'">
                <div style=" background-color:'.get_theme_mod( 'background_setting_header', '#FFFFFF' ).'"> 
                    %s
                    %s
                    %s
         ...
         */
        $format_header = '
            <header class="%s header" id="opt_header_seven" style=" background-color:'.get_theme_mod( 'background_setting_header', '#FFFFFF' ).'">
                <div>
                    %s
                    %s
                    %s
         ...
         */
        $format_header = '
            <header class="%s header" id="opt_header_ten" style=" background-color:'.get_theme_mod( 'background_setting_header', '#FFFFFF' ).'">
                <div> 
                    %s
                    %s
                    %s
